...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GalleryInfo'
        db.create_table(u'photologue_galleryinfo', (
        ...
        db.send_create_signal(u'photologue', ['GalleryInfo'])


    def backwards(self, orm):
        # Deleting model 'GalleryInfo'
        db.delete_table(u'photologue_galleryinfo')

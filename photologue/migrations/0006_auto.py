...
class Migration(SchemaMigration):
    ...
    models = {
        u'photologue.gallery': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'galleries'", 'to': u"orm['photologue.Photo']", 'through': u"orm['photologue.GalleryInfo']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'tags': ('photologue.models.TagField', [], {'max_length': '255', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'title_slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'})
        },
        u'photologue.galleryinfo': {
            'Meta': {'ordering': "('number',)", 'object_name': 'GalleryInfo'},
